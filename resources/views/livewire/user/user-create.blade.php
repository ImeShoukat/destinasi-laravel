<div class="max-w-xl mx-auto px-4 py-6">
    <h1 class="text-2xl font-semibold mb-6 text-zinc-800 dark:text-zinc-100">Tambah User</h1>
    ...
    <form wire:submit.prevent="store" class="space-y-4">
        ...
        <div>
            <label class="block mb-1 text-sm font-medium text-zinc-700 dark:text-zinc-300">Password</label>
            <input type="password" wire:model.defer="password" class="w-full px-4 py-2 border rounded-lg dark:bg-zinc-900 dark:border-zinc-700 dark:text-white">
            @error('password') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
        </div>

        <div>
            <label class="block mb-1 text-sm font-medium text-zinc-700 dark:text-zinc-300">Konfirmasi Password</label>
            <input type="password" wire:model.defer="password_confirmation" class="w-full px-4 py-2 border rounded-lg dark:bg-zinc-900 dark:border-zinc-700 dark:text-white">
